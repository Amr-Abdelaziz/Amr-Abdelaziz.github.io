<script lang="ts">
  ...
  import HyperDarkControls from "../../components/HyperDark/HyperDarkControls.svelte";
</script>

<Section name="feature">
  <HeroHeader
    class="mx-auto mb-8 max-w-screen-md sm:mx-0 lg:mb-16"
  ...
  <FeatureDefault>
    <a href="https://scholar.google.com/citations?user=F4-58nIAAAAJ&hl=en">
      <FeatureItem>
    ...
    <FeatureItem>
      ...
      <svelte:fragment slot="h3"></svelte:fragment>
      <svelte:fragment slot="paragraph">
      </svelte:fragment>
    </FeatureItem>
  </FeatureDefault>
